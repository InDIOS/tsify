...
module.exports = function (ts) {
	...
	Host.prototype._output = function (filename) {
		...
		if (output) {
			...
			if (this.HMR_PARTIAL && !tsd.match(outputCanonical) && !this.isExclude(filename)) {
	...
	Host.prototype.isExclude = function (filename) {
		var isExclude = false;
		var excludeFiles = Array.isArray(this.vue.excludeHmrFiles) ? this.vue.excludeHmrFiles : [];
